...
import type { IProductionOrderParams } from '../types/productionOrderTypes';
...
export const productionOrderApi = {
  async getStats(params?: IProductionOrderParams): Promise<IProductionOrderStats> {
    return await axiosClient.get('/production-orders/stats/search', { params });
  },

  async search(params?: IProductionOrderParams): Promise<any> {
    return await axiosClient.get('/production-orders/search', { params });
  },

  async getFilters(dateFrom?: string, dateTo?: string): Promise<any> {
    return await axiosClient.get('/production-orders/filters', {
      params: { dateFrom, dateTo },
    });
  },

  async getFiltersV2(dateFrom?: string, dateTo?: string): Promise<any> {
    return await axiosClient.get('/production-orders/filters-v2', {
      params: { dateFrom, dateTo },
    });
  },

  async getStatsV2(params?: IProductionStatusParams): Promise<IProductionStatusStats> {
    return await axiosClient.get('/production-orders/stats-v2/search', { params });
  },

  async searchV2(params?: IProductionStatusParams): Promise<any> {
  ...
  async getBatches(productionOrderId: number): Promise<any> {
    return await axiosClient.get('/production-order-detail/batches', {
      params: { productionOrderId },
    });
  },

  async getIngredients(productionOrderNumber: string): Promise<any> {
  ...
  async getBatchCodesWithMaterials(productionOrderNumber: string): Promise<any> {
